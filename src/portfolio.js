...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/10_NuU4aiTSiaHTuV8xZ8iZVmY9r-ttTk/view?usp=sharing", // Set to empty to hide the button
...
const skillsSection = {
  title: "What I Do",
  subTitle: "Robotics & Computer Vision Engineer focused on perception systems for real-time autonomous applications",

  skills: [
    emoji("⚡ Computer Vision & Deep Learning: Building perception models using CNNs, Transformers, and multimodal learning for image and video understanding."),
    
    emoji("🤖 Robotics & Autonomous Systems: Building ROS2-based robotic applications involving perception, control, simulation, and real-time decision-making."),
    
    emoji("🔬 Applied AI & Engineering: Translating research into deployable systems through real-time inference, simulation, and ML-based automation.")
  ],
...
// Education Section
  ...
  const educationInfo = {
    ...
    schools: [
      ...
      logo: require("./assets/images/rwth_logo.png"),
      subHeader: "M.Sc. Robotic Systems Engineering, Track: Data & AI",
      duration: "Oct 2025 - Present",
      desc: "Focus on robotics, computer vision, and learning-based autonomous systems with coursework in perception, control, and intelligent robotics.",
      descBullets: [
        "Core areas: robotic perception, autonomous systems, and machine learning for robotics applications",
        "Relevant coursework: robotic systems, kinematics & dynamics, computer vision, reinforcement learning",
      ]
    },
      {
        schoolName: "National Institute of Technology Tiruchirappalli",
        logo: require("./assets/images/NITT_logo_transparent back.png"),
        subHeader: "Bachelor of Technology in Production Engineering, & Minor in Computer Science",
...
const workExperiences = {
  ...
  experience: [
    {
      role: "Research Assistant – Cross-Modal Depth Estimation (ACDC)",
      company: "iKA, RWTH Aachen University",
      companylogo: require("./assets/images/rwth_logo.png"),
      date: "Apr 2026 – Present",
      desc: "Cross-modal perception for traffic light detection using LiDAR-camera alignment.",
      descBullets: [
        "Developed geometric fusion of LiDAR and camera using transformation chains and perspective projection.",
        "Implemented frustum-based filtering and depth refinement for robust real-time perception in autonomous scenarios."
      ]
    },
    {
      ...
      descBullets: [
        "Built a real-time defect detection using fine-tuned YOLOv12 Roboflow API for metal additive manufacturing.",
        " Developed a Flask-based image/video inspection platform and an AI assistant with model precision."
